...
(function () {
  ...
  var DESKTOP = {
    ...
    card:   { x: [[F.C,137],[F.D,178]], y: [[F.C,567],[F.D,432],[F.E,392],[F.G6,352]],
              w: [[F.C,1066],[F.D,835],[F.G6,879]], h: [[F.C,377],[F.D,333]],
              o: [[F.C,0],[F.D,0.43],[F.G6,1]] },
    hi:     { x: [[F.C,246]], y: [[F.C,399],[0.335,400]],
              s: [[F.C,1],[0.335,0.21]],
              o: [[0.20,0],[0.235,1],[0.30,1],[0.335,0]] },
    head:   { x: [[F.A,227]], y: [[F.A,400]] },
    ln1:    { o: [[0.30,0],[0.35,1]] },
    ln2:    { o: [[0.33,0],[0.39,1]] },
    ln3:    { o: [[0.72,0],[F.J,1]] },
    ln4:    { o: [[0.90,0],[0.96,1]] },
    ...
    photo:  { r: [[F.L,1564]], y: [[F.L,352]], w: [[F.L,478]], h: [[F.L,668]],
              o: [[0.93,0],[F.L,1]] },
    /* software row: group box per frame; each tile keeps its
       normalised slot and lerps from "scattered" to "aligned". */
    toolBox: {
      x: [[F.A,238],[F.B,143],[F.C,146],[F.D,147],[F.E,190],[F.G6,225],[F.G7,225],[F.H,225],[F.I,225],[F.J,225],[F.K,225],[F.L,225]],
  ...
  var COMPACT = {
    ...
    profile:{ r: [[0.14,840],[F.C,415],[F.I,415],[F.J,412],[F.K,405]],
              ...
              h: [[F.C,240],[F.K,210]],
              o: [[0.14,0],[0.20,1],[0.93,1],[F.L,0]] },
    card:   { x: [[F.C,8],[F.D,12]], y: [[F.C,360],[F.D,312],[F.E,306],[F.G6,302]],
              w: [[F.C,374],[F.D,366]], h: [[F.C,180],[F.D,168]],
              o: [[F.C,0],[F.D,0.43],[F.G6,1]] },
    hi:     { x: [[F.C,28]], y: [[F.C,326],[0.335,320]],
              s: [[F.C,1],[0.335,0.28]],
              o: [[0.20,0],[0.235,1],[0.30,1],[0.335,0]] },
    head:   { x: [[F.A,28]], y: [[F.A,320]] },
    ln1:    { o: [[0.30,0],[0.35,1]] },
    ln2:    { o: [[0.33,0],[0.39,1]] },
    ln3:    { o: [[0.72,0],[F.J,1]] },
    ln4:    { o: [[0.90,0],[0.96,1]] },
